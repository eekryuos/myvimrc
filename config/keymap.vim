" Disbale annoying Ex-mode keymaps
nn Q <Nop>
nn gQ <Nop>

" Using the EMACS keymaps in the Insert mode
inoremap <C-a> <Home>
inoremap <C-e> <End>
inoremap <C-d> <Del>
inoremap <C-_> <C-k>
...
" using <leader> + numbers to switch tabs
"----------------------------------------------------------------------
...
" using ALT + numbers to switch tabs
...
" allow MacVim to switch tabs by CMD + numbers
if has("gui_macvim")
	set macmeta
